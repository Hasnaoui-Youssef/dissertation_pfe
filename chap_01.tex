...
\begin{table}[htbp]
    ...
    \end{tabularx}
\end{table}
The features that the proprietary debuggers provide for devices based on the ARM architecture are worth examining in turn. ST's tools are specialized forks of open-source projects and are therefore excluded from this comparison.
