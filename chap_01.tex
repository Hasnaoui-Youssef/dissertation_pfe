...
\textit{Due to not being able to obtain and work with the DSTREAM family, it will be ommitted from this comparison.}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\linewidth}{@{}>{\bfseries}l X@{}}
        \toprule
        Probe & IAR & Keil & Segger & Trace Capture Support\\
        \midrule
        I-Jet & \checkmark & \times & \times & \checkmark \footnote{Given the appropriate model} \\
        ULink & \times & \checkmark & \times & \checkmark \footnote{Given the appropriate model} \\
        J-Link/J-Trace & \checkmark & \checkmark & \checkmark & \checkmark \footnote{Given the appropriate model} \\
        STLink & \checkmark & \checkmark & \checkmark & \times \\
        CMSIS-DAP & \checkmark & \checkmark & \checkmark & \times \\
        \midrule
        \bottomrule
    \end{tabularx}
\end{table}
