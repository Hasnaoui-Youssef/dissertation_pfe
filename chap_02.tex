...
\label{sec:cortexm}
This section describes the parts of the ARM Cortex-M architecture on which the debug and trace infrastructure depends. ARM divides its architecture into three profiles addressed to different classes of application. The A-profile targets systems running general-purpose operating systems, the R-profile targets systems with real-time requirements, and the M-profile targets microcontrollers, which is the profile this work concerns.
