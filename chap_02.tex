...
\label{sec:classes}
Debugging techniques are grouped along several independent axes, and a given technique may occupy a position on each of them. Table \ref{tab:debug_axes} states the axes that concern this work and the distinction each draws.
